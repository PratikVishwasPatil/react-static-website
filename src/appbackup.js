...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Divya Bhandare
                </h4>
...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Prathmesh Halande
...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Suparn Marathe
                </h4>
...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Lalit Patil

                </h4>
                <p className="text-xs sm:text-sm text-blue-600 mb-2">Video Editor
                </p>
              </div>
            </SwiperSlide>
...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Akash
                </h4>
...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Tanwee Paranjape
                </h4>
...
"
                ...
                <h4 className="font-semibold text-xs sm:text-sm text-gray-800 mb-1">Kiran Naiknaware
                </h4>
          ...
          <div className="border-t border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-400">
                © 2025 Vedbiz Technologies Private Limited. All rights reserved.
              </p>
            </div>
          </div>
        </div>
